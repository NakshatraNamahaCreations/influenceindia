        ...
        >
          ...
          >
            <div className="flex items-start justify-between gap-6">
              <span className="label text-ink-30 transition-colors duration-500 group-hover:text-paper/40">
                {service.index}
              </span>
            ...
            <div className="flex flex-col gap-5">
              ...
              <p className="max-w-md text-[0.95rem] leading-relaxed text-ink-70 transition-colors duration-500 group-hover:text-paper/70">
                {service.summary}
              </p>
            </div>
          </Link>
